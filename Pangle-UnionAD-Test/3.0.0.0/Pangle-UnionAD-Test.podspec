...
Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/bytedance-tech/AlphaTest.git'
  s.source           = { :git => 'https://github.com/bytedance-tech/AlphaTest.git', :tag => s.version.to_s }
  s.platform     = :ios, "9.0"  
